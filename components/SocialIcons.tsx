// Inline SVG social icons — using custom paths because lucide-react no longer ships
// brand icons (Facebook, Instagram, Twitter, LinkedIn) due to trademark restrictions.
